...
function print_ticket($id_factura)
{
	...
	if($nrows_fact>0){
		...
		$info_factura.=$esp_init."COMPROBANTE # ".$num_fact."|";
...
function print_fact($id_factura,$tipo_id,$nombreapecte,$direccion){
	...
	if($nrows_fact>0){
		...
		$sql_fact_det="SELECT producto.id_producto, producto.descripcion, producto.exento, presentacion.nombre as desprep, presentacion_producto.descripcion AS descpre, presentacion_producto.unidad, factura_detalle.* FROM factura_detalle JOIN producto ON factura_detalle.id_prod_serv=producto.id_producto JOIN presentacion_producto ON factura_detalle.id_presentacion=presentacion_producto.id_pp JOIN presentacion ON presentacion.id_presentacion=presentacion_producto.id_presentacion WHERE factura_detalle.id_factura='$id_factura'
		 ";
